...
func CalcKey(id string, analyzerVersions map[string]int, artifactOpt artifact.Option) (string, error) {
	...
	keyBase := struct {
		...
		SkipFiles        []string
		SkipDirs         []string
	}{id, analyzerVersions, artifactOpt.SkipFiles, artifactOpt.SkipDirs}
